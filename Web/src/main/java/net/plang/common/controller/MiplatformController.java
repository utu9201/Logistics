package net.plang.common.controller;
...
public class MiplatformController extends AbstractController {
    ...
    protected ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        Class<? extends MiplatformController> controllerClass = getClass();
